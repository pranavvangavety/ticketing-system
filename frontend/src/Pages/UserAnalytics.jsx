...
import { FolderOpen, HelpCircle, CheckCircle2, Download } from "lucide-react";
    ...
    useEffect(() => {
        const fetchSummary = async () => {
            try {
                ...
                const response = await axios.get('http://localhost:8080/users/analytics/summary', {
            ...
            <div className="h-full overflow-y-auto scroll-container px-4 py-6">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 gap-4">
                        ...
                        <button
                            onClick={() => downloadAnalyticsCSV(localStorage.getItem("token"), true)}
