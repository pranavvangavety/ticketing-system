...
function AdminCreatedTickets() {
    ...
    useEffect(() => {
        ...
        const endpoint = tab === "open"
            ? `/admin/tickets/by-admin/open`
            : `/admin/tickets/by-admin/closed`;
    ...
    return (
        ...
        <div className="fixed inset-0 top-[64px] bg-gradient-to-b from-white via-blue-50 to-purple-50 overflow-visible">
            <div className="h-full overflow-y-auto p-6 scroll-container">
                <div className="p-6">
                    ...
                    <div className="overflow-visible shadow rounded-xl relative">
